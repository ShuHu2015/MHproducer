...
static
# endif
void sha512_block_data_order(SHA512Context *ctx, const void *in, size_t num);
...
int SHA512Update(SHA512Context *c, const void *_data, size_t len)
{
    SHA_LONG64 l;
...
{
    return SHA512Update(c, data, len);
}
 ...
 */ static void sha512_block_data_order(SHA512Context *ctx, const void *in,
                                        size_t num)
{
